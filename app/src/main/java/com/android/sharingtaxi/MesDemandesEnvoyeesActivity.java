...
public class MesDemandesEnvoyeesActivity extends Activity
{
    private ListView listeViewDemandesOUT;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_mes_demandes_envoyees);
        ...
        // Listview
        listeViewDemandesOUT = (ListView) findViewById(R.id.listViewMesDemandesEnvoyees);
        ...
        for(int i = 0;i<lesDemandes.size();i++){
           ...
           if (lesDemandes.get(i).getUserID() == userID){
        ...
        adapter = new DemandeTrajetAdapter(this, mesDemandes, mesTrajets, userID, "Sent");
        trajetRepository.Close();
        alerteRepository.Close();

        listeViewDemandesOUT.setAdapter(adapter);

        registerForContextMenu(listeViewDemandesOUT);
        //Slide menu test
            ...
            public void onClick(View v) {
                if (isExpanded) {
                    ...
                    mesTrajetsList.setOnClickListener(new OnClickListener(){
                        public void onClick(View view){
                            Intent intent = new Intent(MesDemandesEnvoyeesActivity.this, MesTrajetsActivity.class);
                    ...
                    mesDemandesList.setOnClickListener(new OnClickListener(){
                        public void onClick(View view){
                            Intent intent = new Intent(MesDemandesEnvoyeesActivity.this, MesDemandesRecuesActivity.class);
                            intent.putExtra("userID", userID);
                            startActivityForResult(intent,1);
                        }
                    });
                    ...
                    mesReponses.setOnClickListener(new OnClickListener(){
                        public void onClick(View view){
                            Intent intent = new Intent(MesDemandesEnvoyeesActivity.this, MesDemandesEnvoyeesActivity.class);
                            intent.putExtra("userID", userID);
                            startActivityForResult(intent,1);
                        }
                    });
                    compte2.setOnClickListener(new OnClickListener(){
                        public void onClick(View view){
                            Intent intent = new Intent(MesDemandesEnvoyeesActivity.this, CompteUserActivity.class);                
                            intent.putExtra("userID", userID);
                            startActivityForResult(intent,1);
                        }
                    });
                    ...
                    trajets2.setOnClickListener(new OnClickListener(){
                        public void onClick(View view){
                            Intent intent = new Intent(MesDemandesEnvoyeesActivity.this, TousLesTrajetsActivity.class);
                                intent.putExtra("userID", userID);
        ...
        deconnexion.setOnClickListener(new OnClickListener(){
            public void onClick(View view){
                Intent intent = new Intent(MesDemandesEnvoyeesActivity.this, ConnexionActivity.class);              
                startActivityForResult(intent,1);
            }
        });
    }
